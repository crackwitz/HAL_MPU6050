...
typedef enum
{
	MPU6050_DataRate_8KHz = 0, /*!< Sample rate set to 8 kHz */
	MPU6050_DataRate_4KHz = 1, /*!< Sample rate set to 4 kHz */
	MPU6050_DataRate_2KHz = 3, /*!< Sample rate set to 2 kHz */
	MPU6050_DataRate_1KHz = 7, /*!< Sample rate set to 1 kHz */
	MPU6050_DataRate_500Hz = 15, /*!< Sample rate set to 500 Hz */
	MPU6050_DataRate_250Hz = 31, /*!< Sample rate set to 250 Hz */
	MPU6050_DataRate_125Hz = 63, /*!< Sample rate set to 125 Hz */
	MPU6050_DataRate_100Hz = 79, /*!< Sample rate set to 100 Hz */
} MPU6050_DataRate;
/**
 * @}
 */
...
{
	/* Private */
	I2C_HandleTypeDef *phi2c; /*!< pointer to I2C handle */
 ...
 * @retval Member of @ref MPU6050_Result_t enumeration
 */
MPU6050_Result MPU6050_ReadInterrupts(MPU6050 *DataStruct,
